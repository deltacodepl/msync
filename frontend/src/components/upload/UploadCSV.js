...
import UploadCSVButtons from '../components/UploadCSVButtons';
import UploadCSVHeader from '../components/UploadCSVHeader';
import UploadCSVResult from '../components/UploadCSVResult';
...
const UploadCSV = () => {
  ...
  const getClassificationResult = (obj) => {
    axios
      .get(`http://127.0.0.1:8000/api/UploadCSV/${obj.data.id}/`, {
        headers: {
          accept: 'application/json',
        },
      })
  ...
  return (
    <>
      <Head>
        <title>Image UploadCSV | Image Classification</title>
      </Head>
      <Box
